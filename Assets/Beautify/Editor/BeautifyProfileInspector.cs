...
namespace BeautifyEffect {
    ...
    public class BeautifyProfilenspector : Editor {
        ...
        bool expandOutlineSection, expandBlurSection, expandAASection;
        ...
        SerializedProperty _depthOfField, _depthOfFieldTransparencySupport, _depthOfFieldExclusionLayerMask, _depthOfFieldAutofocus, _depthofFieldAutofocusViewportPoint, _depthOfFieldAutofocusLayerMask, _depthOfFieldAutofocusMinDistance, _depthOfFieldAutofocusMaxDistance;
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(_antialiasStrength, new GUIContent("AntiAliasing", "Intensity of antialiasing."));
            if (expandAASection) {
